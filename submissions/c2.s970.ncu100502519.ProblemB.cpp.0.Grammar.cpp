...
int main(){
	...
	while(cin >> t){
		...
		else if(step==3 && firstStr==true && (((int)t>=97&&(int)t<=122)||((int)t>=65&&(int)t<=90)||((int)t>=48&&(int)t<=57))){r=r+"string "+t; firstStr=false;}
		else if(step==3 && firstStr==false && (((int)t>=97&&(int)t<=122)||((int)t>=65&&(int)t<=90)||((int)t>=48&&(int)t<=57))){r=r+t;havestring=true;}
		else if(step==3 && quoteCheck==true && t=='"'){if(havestring=true){r=r+"\n";}r=r+"\quote \" "+"\n"; step++;}
		else if(step==4 && t=='p'){r=r+"print p"+"\n"; step++;}
		else if(step==5 && t==id){r=r+"id "+t; break;}
