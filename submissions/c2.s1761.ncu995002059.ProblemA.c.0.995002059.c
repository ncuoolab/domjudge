        ...
        if(known_flag==0)
        {
            ...
            if(pch[i]=='\0')
            {
                ...
                if(tok_num<=2)       //記錄前三個gram
                {
                    switch (tok_num)
                    {
                    case 0: {strcpy(first,pch);haha=i+1;    if(haha!=2){error_flag=1;}};
                    break;
                    case 1: {strcpy(second,pch);error_flag=1;    if(haha!=2){error_flag=1;}};
                    break;
                    case 2: {strcpy(third,pch);Val_case=1;haha=i+1;    if(haha!=2){error_flag=1;}};
                    break;
                    default: break;
                    }
                }
